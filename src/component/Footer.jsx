...
const Footer = () => {
  ...
  return (
    <div className="relative">
      <div className="absolute overflow-hidden flex flex-col eight:flex-row  gap-6 top-[-80px] bg-black text-white h-[300px] six:h-[230px] eight:h-[150px] w-[90%]  nine:w-[80%] left-1/2 -translate-x-1/2 rounded-3xl p-4">
        <div className="w-full flex justify-center items-center">
          <h1 className="text-4xl font-bold text-white pl-4">STAY UPTO DATE ABOUT OUT LATEST OFFERS</h1>
        </div>

        <div className="flex flex-col gap-2 eight:gap-4 w-full">
          <input type="email" name="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="enter your email address" className="text-black pl-2 outline-none rounded-full p-2 w-[80%] nine:w-[70%] mx-auto" />
         <button className="bg-white text-black  rounded-full p-2 w-[80%] nine:w-[70%] mx-auto hover:scale-[1.1]">Subscribe to Newsletter</button>
        </div>
      </div>
      <div className="bg-gray-200 p-4 mt-[100px]">
        <div className="small-grid w-[95%] nine:w-[90%] mx-auto mt-[220px] six:mt-[150px] eight:mt-[110px]">
          <div className="item flex flex-col gap-4 w-[80%] ">
            <h1 className="font-bold text-black text-3xl">SHOP.CO</h1>
            <p>
              We have clothes that suit your style and which you are proud to
              wear. From women to men{" "}
            </p>
            <div className="flex gap-2">
              <span className="cursor-pointer hover:scale-[1.2]">
              <svg
                width="28"
                height="28"
                viewBox="0 0 28 28"
          ...
          <div className="item flex flex-col gap-4">
            <h1 className="font-bold text-black text-xl">COMPANY</h1>
          ...
          <div className="item flex flex-col gap-4">
            <h1 className="font-bold text-black text-xl">HELP</h1>
          ...
          <div className="item flex flex-col gap-4">
            <h1 className="font-bold text-black text-xl">FAQ</h1>
            <p className="cursor-pointer">Account</p>
            <p className="cursor-pointer">Manage Deliveries</p>
            <p className="cursor-pointer">Orders</p>
            <p className="cursor-pointer">Payments</p>
          </div>

          <div className="item flex flex-col gap-4">
    <h1 className="font-bold text-black text-xl">RESOURCES</h1>
    <p className="cursor-pointer">Free eBooks</p>
    <p className="cursor-pointer">Development Tutorial</p>
    <p className="cursor-pointer">How To -Blog</p>
    <p className="cursor-pointer">Youtube Playlist</p>
          </div>
        </div>
        <hr 
        className="w-[90%] mx-auto mt-6 border  border-gray-400 " />

<div className="w-[95%] nine:w-[90%] mx-auto pt-4 flex flex-col gap-4 seven:gap-0 seven:flex-row justify-center seven:justify-start items-center">
<p>Shop.co © 2020-2025, All Rights Reserved</p>
<div className="flex justify-center  gap-1 six:gap-2 ml-none seven:ml-auto overflow-hidden">
  <img src={visa} alt="visa" className="cursor-pointer hover:scale-[1.2]" />
  <img src={debit} alt="debit" className="cursor-pointer hover:scale-[1.2]" />
  <img src={paypal} alt="paypal" className="cursor-pointer hover:scale-[1.2]" />
  <img src={ipay} alt="ipay" className="cursor-pointer hover:scale-[1.2]"/>
  <img src={gpay} alt="gpay" className="cursor-pointer hover:scale-[1.2]"/>
</div>
</div>
      </div>
